        ...
        <section className="benefits">
            <div className="container">
                ...
                <p className="benefits__desc">
                    Aproveitamos o Open Banking para transformar sua conta bancária em seu centro
                    financeiro. Controle suas finanças como nunca antes.
                </p>

                <ul className="benefits__list">
                    {benefits.map(({ icon, title, desc }) => (
                        <li key={title} className="benefits__item" data-animate>
                            <div className="benefits__item__icon">{React.createElement(icon)}</div>
